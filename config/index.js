export const config = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "小黄", "year": "2001", "date": "02-21", isShowAge: true},
        {"type": "*节日", "name": "同床共枕纪念日", "year": "2022", "date": "08-16"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "节日", "name": "心动纪念日", "year": "2022", "date": "07-23"},
      ],
    ...
    },
    {
      ...
      name: "陈平安",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "o74V76ABf4TIPSEEf5jKEMsng1Ps",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "yUZSwIJO6EfoyHWP0jvJqv4XVr21lr2dbPuWLicLFYA",
      // 所在省份
      province: "河北",
  ...
  CALLBACK_TEMPLATE_ID: "PHtV-s4Ca8HON91-DVDKRlA7Ms9cG5UhKm2LJvw2ROo",
